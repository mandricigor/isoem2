...
1. Create a isoem directory and download the compressed ISOEM-1.1.1
   from http://dna.engr.uconn.edu/software/IsoEM/IsoEM-1.1.1.zip 

2. Uncompress IsoEM-1.1.1.zip into the directory.

3. [Optional] On windows you might want to add the IsoEM 
...
4. If you want to rebuild isoem, run the unix script, build,
